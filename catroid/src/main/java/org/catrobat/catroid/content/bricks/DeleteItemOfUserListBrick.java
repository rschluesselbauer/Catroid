...
import org.catrobat.catroid.ui.UserListItemSelectedListenerImpl;
import org.catrobat.catroid.ui.UserListTouchListenerImpl;
...
public class DeleteItemOfUserListBrick extends UserListBrick {
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		userListSpinner.setOnTouchListener(new UserListTouchListenerImpl(this));
		userListSpinner.setOnItemSelectedListener(new UserListItemSelectedListenerImpl(this));
